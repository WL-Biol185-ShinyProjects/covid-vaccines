...
dashboardPage(skin = "green",
  ...
  dashboardHeader(title = p("COVID-19 Global Vaccination", 
                            style = "color: aqua;"),
             titleWidth = 450, 
  
             dropdownMenu(type = "messages",
              messageItem(from = "The Creators",
       ...
       tabItems(
          ...
          tabItem(tabName = "Variants",
                ...
                p("As the pandemic continues to evolve, different 
                   ...
                   border to compare the differences inwhen variants emerged in 
